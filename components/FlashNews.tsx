...
export default function FlashNews() {
  return (
    <div className="bg-gradient-to-r from-sky-600 to-cyan-600 text-white py-3 overflow-hidden shadow-lg">
      <div className="flex items-center">
        <div className="flex-shrink-0 bg-white text-sky-600 px-4 py-1 font-bold text-sm rounded-r-lg mr-4">
